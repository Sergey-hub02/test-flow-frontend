...
const AttemptCard = ({ guid, title, user, createdAt, updatedAt, grade, showLink }: AttemptCardProps) => {
    ...
    return (
        <Card bg="light">
            ...
            <Card.Body>
                <Card.Subtitle className="text-muted mb-1">Обучающийся: {user}</Card.Subtitle>
